...
func TestDetails(t *testing.T) {
	...
	t.Run("Update success", func(t *testing.T) {
		...
		newName := "vjetgolang"
		newEmail := "vjetgolang@vjetgolang.com"
		newWebsite := "https://vjetgolang.me"
		...
		dbImageURL := "https://vjetgolang.me/static/696292a38f493a4283d1a308e4a11732/84d81/Profile.jpg"
