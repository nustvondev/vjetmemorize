...
import (
	...
	"github.com/nustvondev/vjetmemorize/account/model/fixture"
...
func TestSignin(t *testing.T) {
	...
	email := "vjet@vjetgolang.com"
	validPW := "pasword1234!"
	hashedValidPW, _ := hashPassword(validPW)
	invalidPW := "paswordtest123!"
